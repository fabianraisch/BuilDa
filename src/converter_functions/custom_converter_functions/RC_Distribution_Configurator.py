...
class RC_Distribution_Configurator(ConverterFunction):
    '''
    Sets up preconfigured R and C distribution profiles. 
    ...
    def __init__(self):
        super().__init__()
        # RC_distribution_profiles_n3, only use, when number of elements n=3,
        # Groupwise definition of components possible (syntax: "floor|roof|extWall|...")
        # ToDo_Thomas: This seems like a pre-setup of something, but I do not understand for what case. Maybe short description of why this pre-setup is neccesary and when to use it.  
